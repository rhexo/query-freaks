...
namespace sql {
  ...
  namespace helper {
    ...
    struct impl_fields_part<N,F,Fields...>
    {
      ...
      template <class ...Args>
      std::string operator()(binder<Args...>& b) {
        return std::string(", ") + F()(b) + impl_fields_part<N+1, Fields...>()(b);
      }
    ...
    struct impl_fields_part<0,F,Fields...>
    {
      ...
      template <class ...Args>
      std::string operator()(binder<Args...>& b) {
        return  F()(b) + impl_fields_part<1, Fields...>()(b);
      }
 ...
 //     return helper::impl_into_part<Table,0,Fields...>()();
  ...
  namespace helper {
    ...
    struct impl_values_part<N,F,Fields...>
    {
      ...
      template <class ...Args>
      std::string operator()(binder<Args...>& b) {
        return std::string(", ") + F()(b) + impl_values_part<N+1, Fields...>()(b);
      }
    ...
    struct impl_values_part<0,F,Fields...>
    {
      ...
      template <class ...Args>
      std::string operator()(binder<Args...>& b) {
        return  F()(b) + impl_values_part<1, Fields...>()(b);
      }
